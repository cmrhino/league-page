...
export const managers = [
     {
      ...
      "bio": "Lorem ipsum...",
      "photo": "/managers/where-the-wild-things-are-FF.png", // square ratio recommended (no larger than 500x500)
     ...
     },
     {
       ...
       "location": "Quakertown", // (optional)
       "bio": "Lorem ipsum...",
       "photo": "/managers/mile-high-monsters.png", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
     ...
     },
  {
       ...
       "location": "Waukesha", // (optional)
       "bio": "Lorem ipsum...",
       "photo": "/managers/lisa.png", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
       "favoriteTeam": "", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
       "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
     ...
     },
  {
       ...
       "location": "Waukesha", // (optional)
       "bio": "Lorem ipsum...",
       "photo": "/managers/sheryl.png", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
       "favoriteTeam": "", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
       "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
